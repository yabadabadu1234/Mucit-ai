...
UZUV_SOFRASI: Dict[int, Uzuv] = {
    ...
    10: Uzuv("nefs.idrak", "tezat kutbu (𝒪₁₁'e verilir)"),
    ...
    16: Uzuv("nefs.akil", "deneme-yanılma", vekil=True,
             not_="keşif/istismar dengesi hâlâ sabit katsayılı"),
    17: Uzuv("nefs.akil", "Bayes kuralı ve normalizasyon"),
    18: Uzuv("nefs.sahit", "şahit başına dik Procrustes kaidesi (kapalı form)"),
    19: Uzuv("nefs.akil", "temsil", vekil=True,
             not_="mizan.istikra.temsil_hukmu bağlanmadı"),
    20: Uzuv("nefs.akil", "teşbih", vekil=True),
    ...
    26: Uzuv("nefs.murakabe", "en kötü hâl (asgarî) araması"),
    27: Uzuv("nefs.murakabe", "kılcal kusur haritası"),
    ...
    31: Uzuv("nefs.murakabe", "Monte Carlo âkıbet ve risk"),
    32: Uzuv("mizan.istikra", "ardışıklık kaidesi ``(k+α)/(n+α+β)`` → makam, sükût"),
    33: Uzuv("nefs.murakabe", "mizan ve rejim değişimi"),
    34: Uzuv("nefs.murakabe", "tafsil sadakati"),
    35: Uzuv("nefs.murakabe", "siyak-sibak tefsiri"),
    ...
    40: Uzuv("nefs.beyan", "simetrik harmoni + altın oran"),
