...
\mathcal{Q}_{\text{Eksikİstikra}} &: P\left( \forall x \in K, P(x) \right) = 1 - \prod_{i=1}^k (1 - p_i)
\end{align}
...
\mathbf{T} &: \Box P \implies P, \quad \mathbf{4} : \Box P \implies \Box \Box P, \quad \mathbf{5} : \alpha \implies \Box \Diamond \alpha
\end{align}
