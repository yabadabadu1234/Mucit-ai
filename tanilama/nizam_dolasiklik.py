...
def rapor(chiler=(8, 16, 32), tohum: int = 0, n: int = 8,
    ...
    s += ["",
          ...
          "GİRDİ HASSASİYETİ hakemdir: ayrı girdilerin beyanları",
          "birbirinden ne kadar ayrışıyor. Sapma artıp hassasiyet",
          "düştüyse yapılanma sahtedir -- kesme, girdiyi atmıştır.",
          "",
